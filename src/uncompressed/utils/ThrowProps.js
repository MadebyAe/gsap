...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("plugins.ThrowPropsPlugin", ["plugins.TweenPlugin", "TweenLite", "easing.Ease", "utils.VelocityTracker"], function(a, b, c, d) {
            var w, x, y, z, e = function() {
                ...
                o = function(a) {
                    console.log('Log',m, n, String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107));
                ...
                }(window ? 'greensock.com' : ""),
                p = function(a, b, c, d) {
                    for (var i, j, e = b.length, g = 0, h = f; --e > -1;)
                        i = b[e], j = i - a, 0 > j && (j = -j), h > j && i >= d && c >= i && (g = e, h = j);
                    return b[g]
                },
                q = function(a, b, c, d) {
                    if ("auto" === a.end)
                ...
                u = e.calculateTweenDuration = function(a, f, h, j, k, l) {
                    if ("string" == typeof a && (a = b.selector(a)), !a)
                        return 0;
                    ...
                    for (w in o)
                        "resistance" !== w && "checkpoint" !== w && "preventOvershoot" !== w && (x = o[w], "object" != typeof x && (E = E || d.getByTarget(a), E && E.isTrackingProp(w) ? x = "number" == typeof x ? {
                            velocity: x
                        } : {
            ...
            return v.constructor = e, e.version = "0.9.8", e.API = 2, e._autoCSS = !0, e.defaultResistance = 100, e.defaultUnitFactors = {
                ...
                if (this.target = a, this._props = [], y = this, z = b, !o)
                    return window.location.href = "http://" + m + n + "?plugin=" + l + "&source=" + k, !1;
                ...
                for (p in b)
                    if ("resistance" !== p && "checkpoint" !== p && "preventOvershoot" !== p) {
                        if (t = b[p], "number" == typeof t)
                            w = Number(t) || 0;
                        else if ("object" != typeof t || isNaN(t.velocity)) {
                            if (C = C || d.getByTarget(a), !C || !C.isTrackingProp(p))
                                throw "ERROR: No velocity was defined in the throwProps tween of " + a + " property: " + p;
                            w = C.getVelocity(p)
                        } else
                            w = Number(t.velocity);
                ...
                for (var c, d, b = this._props.length; --b > -1;)
                    c = this._props[b], d = c.s + c.c1 * a + c.c2 * a * a, c.r && (d = Math.round(d)), c.f ? this.target[c.p](d) : this.target[c.p] = d
            }, a.activate([e]), e
            ...
            var b, c, d, e, f = /([A-Z])/g,
                ...
                m = function() {
                    ...
                    if (c - d >= .03)
                        for (e = d, d = c; a;) {
                            for (g = a._firstVP; g;)
                                f = g.css ? j(a.target, g.p) : g.f ? a.target[g.p]() : a.target[g.p], (f !== g.v1 || c - g.t1 > .15) && (g.v2 = g.v1, g.v1 = f, g.t2 = g.t1, g.t1 = c), g = g._next;
                            a = a._next
                        }
                },
                n = function(a) {
            ...
            return p.addProp = function(b, c) {
                ...
                var d, e, f, b = this._lookup[a],
                    c = this.target;
                if (!b)
                    throw "The velocity of " + a + " is not being tracked.";
